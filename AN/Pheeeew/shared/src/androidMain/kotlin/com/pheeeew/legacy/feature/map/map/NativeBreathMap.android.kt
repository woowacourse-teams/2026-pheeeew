...
internal actual fun NativeBreathMap(
    ...
    onBoundsChanged: (com.pheeeew.legacy.domain.model.sigh.SighBounds) -> Unit,
...
private class AndroidBreathMapHost(
    ...
    private val onBoundsChanged: (com.pheeeew.legacy.domain.model.sigh.SighBounds) -> Unit,
    ...
    private var renderedCurrentLocation: com.pheeeew.legacy.domain.model.location.CurrentLocation? = null
    ...
    private val cameraIdleListener =
        MapLibreMap.OnCameraIdleListener {
            ...
            onBoundsChanged(
                com.pheeeew.legacy.domain.model.sigh.SighBounds.fromViewport(
