...
import com.pheeeew.legacy.feature.map.MapFocusRequest
...
internal class AndroidMapCamera {
    ...
    fun render(
        ...
        cameraCommand: com.pheeeew.legacy.feature.map.map.MapCameraCommand?,
    ...
    private fun setInitialCenterIfNeeded(
        ...
        map.moveCamera(
            CameraUpdateFactory.newLatLngZoom(
                ...
                com.pheeeew.legacy.feature.map.map.MapDarkStyle.INITIAL_ZOOM,
            ),
        )
        if (isProvisional) {
    ...
    private fun consumeFocusRequest(
        map: MapLibreMap,
        focusRequest: com.pheeeew.legacy.feature.map.MapFocusRequest?,
    ) {
        focusRequest ?: return
        ...
        map.animateCamera(
            CameraUpdateFactory.newLatLngZoom(
                ...
                com.pheeeew.legacy.feature.map.map.MapDarkStyle.FOCUS_ZOOM,
            ),
